...
/**
 * @extends ServiceEntityRepository<UserApplication>
 *
 * @implements PasswordUpgraderInterface<UserApplication>
 *
 ...
 */
class UserApplicationRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    {
        if (!$user instanceof UserApplication) {
