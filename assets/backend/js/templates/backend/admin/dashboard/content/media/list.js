...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const resetFormButton = document.getElementById('refresh-media-image-list-js');
    const searchFormInput = document.getElementById('search-media-image-input-js');
    const suggestionsList = document.getElementById('search-media-image-suggestions');
    const deleteBackendPageLinks = document.querySelectorAll('.link-delete-media-image-js');*/
